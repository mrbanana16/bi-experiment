...
**聚类分布**：
  ...
  - Cluster 1（加购未转化型）: 2,340 个会话（2.7%）| 均事件 1.0 | 均购买 0.00
  - Cluster 2（直接购买型）: 1,730 个会话（2.0%）| 均事件 1.0 | 均购买 1.00
  - Cluster 3（K-Means 0）: 3,437 个会话（3.9%）| 均事件 2.0 | 均购买 0.00
  - Cluster 4（K-Means 1）: 95 个会话（0.1%）| 均事件 2.1 | 均购买 1.04
  - Cluster 5（K-Means 2）: 182 个会话（0.2%）| 均事件 2.1 | 均购买 0.00
  - Cluster 6（K-Means 3）: 422 个会话（0.5%）| 均事件 3.3 | 均购买 0.00
